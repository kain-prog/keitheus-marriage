...
export default class extends Controller {
    ...
    async submit(event) {
        ...
        const disableBtn = () => {
            submitButton.classList.remove("bg-zinc-300", "cursor-pointer", "hover:text-gray-500", "text-zinc-700", "hover:bg-zinc-200");
            submitButton.classList.add("cursor-normal", "bg-zinc-100", "text-200");
            submitButton.setAttribute("disabled", "true");
        };
        const enableBtn = () => {
            submitButton.classList.add("bg-zinc-300", "cursor-pointer", "hover:text-gray-500", "text-zinc-700", "hover:bg-zinc-200");
